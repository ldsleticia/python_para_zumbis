...
3. O último dígito não pode ser igual ao primeiro, porque isso dá azar. Então, dadas essas regras perfeitamente razoáveis, bem projetadas e maduras, 
...
cont = 0
for f in fones:
    if not item_um(f) and item_dois(f) and f[0] != f[-1]:
        cont += 1
